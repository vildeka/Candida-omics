...
3. **Step 3: Taxonomical-filtering**  
   ...
   Step 6. Check for samples with total taxa < 60% after filtering<br>
   Step 7: Check and replace negative values with zero<br>
   Step 8: Re-normalize each sample to 100%<br>

4. **Step 4: Simplify clade names**  

5. **Step 5: Centered Log Ratio (CLR) Transformation**

6. **Step 6: Exploratory Unsupervised PCA**

7. **Step 7: Exploratory Heatmap**
...
# COLOUR PALLET #
#################
pal <- c("#902267", "#ffa998", "#f588af", "gray") # "gray", #e05e85
pal2 <- c(
  "#f26386",
  "#f588af",
  "#a4d984",
...
## Step 5: Centered Log Ratio (CLR) Transformation
...
## Step 6: Exploratory Unsupervised PCA
...
pal2 <- c("#2266ac", "#91c5de", "gray", "gray")
pal3 <- c("#9e8dec", "#902267", "#cc93cf", "#a5c97b", "#de9548", "gray") #"#abcb4b" "#63d3b4"
...
top_annot <- columnAnnotation(
  ...
  col = list(
    ...
    Clin_gr = set_names(pal, levels(annot_col$Clin_gr)),
    Culture = set_names(
      pal2,
      levels(annot_col$`Fungal culture: C. albicans (y/n)`)
    ),
