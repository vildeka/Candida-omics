...
2. **Step 2: Gene-filtering**  
   Identify treshold for low abundant genes to filter

3. **Step 3: Normalize counts with TMM and CPM log2**

4. **Step 4: Compare re-sequenced samples**

5. **Step 5: Differential Gene Expression analysis**
...
## Step 3: Normalize counts with TMM and CPM log2
